...
def _load_chorus_state():
    default = {
        ...
        "runs": 0,
        "wisdom": 0.0,
        "culture_ratchet": 0,      # ПАТЧ 3d: персистентность культурного храповика
